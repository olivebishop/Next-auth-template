  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-stone-50 dark:bg-stone-900 px-4 sm:px-6 lg:px-8">
      <Card className="w-full max-w-lg p-6 bg-white dark:bg-stone-800 shadow-lg rounded-lg">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-stone-900 dark:text-stone-100">Sign up</CardTitle>
          <CardDescription className="text-stone-600 dark:text-stone-400">Create your account</CardDescription>
        </CardHeader>
        <CardContent>
          <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="space-y-2">
              <Label htmlFor="email" className="text-stone-900 dark:text-stone-100">
                Email
              </Label>
              <Input
                id="email"
        ...
        <CardFooter className="flex flex-col items-center space-y-2">
          <p className="text-sm text-stone-600 dark:text-stone-400">
            Have an account? <a href="/auth/sign-in" className="text-stone-900 dark:text-stone-100 underline">Sign in</a>
          </p>
        </CardFooter>
      </Card>
    </div>
